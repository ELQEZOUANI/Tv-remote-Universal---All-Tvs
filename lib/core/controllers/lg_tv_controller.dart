...
class LGTVController implements TVController {
  ...
  Future<void> sendKey(String keyName) async {
    ...
    if (appId != null) {
      ...
      //   "payload": { "id": "$appId" } }
      appLog('[LG] Launch app $key → appId: $appId');
      return;
    }
    ...
    if (btnName != null) {
      ...
      appLog('[LG] Button $key → $btnName');
      return;
    }

    appLog('[LG] Unknown key: $keyName');
  }
